            ...
            <div class="col">
                <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="bo4 of-hidden">
                                <input class="sizefull s-text15 p-l-22 p-r-22 p-t-15 p-b-15" type="text" autocomplete="off" name="name" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="bo4 of-hidden">
                                        <input class="sizefull s-text15 p-l-22 p-r-22 p-t-15 p-b-15" type="text" autocomplete="off" name="price" required>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="bo4 of-hidden">
                                                <input class="sizefull s-text15 p-l-22 p-r-22 p-t-15 p-b-15" type="number" autocomplete="off" name="stock" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="bo4 of-hidden">
                                <textarea class="sizefull s-text15 p-l-22 p-r-22 p-t-15 p-b-15" style="border: 0;" name="description" autocomplete="off" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="sizefull s-text15 p-r-22 p-t-15 p-b-15" name="photos[]" multiple required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-2">
